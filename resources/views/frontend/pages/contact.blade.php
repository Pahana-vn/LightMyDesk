...
<div class="alert alert-success alert-dismissible fade show" role="alert">
    {{Session::get("note")}}
    <strong> <i class="fa-solid fa-square-check"></i> Contact !</strong>
                    ...
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="contact-item">
                            ...
                            <div class="contact-details">
                                ...
                                <a class="contact-info" href="mailto:info@example.com">aptech.fpt@fe.edu.vn </a>
                                <a class="contact-info" href="mailto:info2@example.com">support.fpt@gmail.com</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="contact-item" onclick="scrollToMap()">
                            <div class="contact-icon">
                            ...
                            <div class="contact-details">
                                ...
                                <p class="contact-info"> 62 Street 36, Van Phuc Residential Area, Thu Duc City</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-12">
                        <div class="contact-item">
                            ...
                            <div class="contact-details">
                                ...
                                <a class="contact-info" href="tel:(307) 555-0133">(84+) 969-790-765</a>
                                <a class="contact-info" href="tel:(307) 555-0133">(84+) 898-512-028</a>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="contact-form-area">
                ...
                <div class="contact-form--wrapper">
                    ...
                    <form action="{{route('fe.contactadd')}}" method="POST" class="contact-form">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12">
                                <fieldset>
                                    <input type="text" name="title" placeholder="Type a subject" />
                                </fieldset>
                            </div>
                            <div class="col-md-6 col-12">
                                <fieldset>
                            ...
                            <div class="col-md-12 col-12">
                                <fieldset>
                                    <textarea cols="20" rows="6" name="desc" placeholder="Write your message here*"></textarea>
                                </fieldset>
            ...
            <iframe id="google-map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3918.547210114064!2d106.708162374806!3d10.845921389307119!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3175286e3301aabd%3A0xdd0d9cd3bcd2146!2zNjIgxJDGsOG7nW5nIDM2LCBLaHUgxJHDtCBUaOG7iyBW4bqhbiBQaMO6YywgVFAuVGjhu6cgxJDhu6ljLCBUaMOgbmggcGjhu5EgSOG7kyBDaMOtIE1pbmgsIFZp4buHdCBOYW0!5e0!3m2!1svi!2s!4v1703833461854!5m2!1svi!2s" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
    </div>
    <!-- about banner end -->

    <!-- script srollpage google map -->
    <script>
