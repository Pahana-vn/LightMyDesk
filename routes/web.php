...
use App\Http\Controllers\Backend\AccountBEController;
...
use App\Http\Controllers\Backend\ContactBEController;
use App\Http\Controllers\Backend\FootbannerController;
use App\Http\Controllers\Backend\LikeBEController;
use App\Http\Controllers\Backend\OrderBEController;
...
Route::match(['get', 'post'], 'contact/add', [ContactController::class, 'add'])->name('fe.contactadd');
...
Route::post('/profile', [SecureController::class, 'check_profile'])->name('fe.check_profile');
//change password
Route::get('/change-password', [SecureController::class, 'change_password'])->name('fe.change_password');
Route::post('/change-password', [SecureController::class, 'check_change_password'])->name('fe.check_change_password');
...
Route::get("/verify/{token}", [CartController::class, 'verify'])->name("fe.verify");

//WishList
Route::get('/likes', [LikeController::class, 'index'])->name('fe.likes.index')->middleware('auth');
Route::post('/chi-tiet/like', [LikeController::class, 'store'])->name('fe.likes.store')->middleware('auth');
...
Route::middleware('phanquyen')->group(function () {
    ...
    //Route Like
    Route::get('admin/like', [LikeBEController::class, 'index'])->name('be.like');
    //Route order
    Route::get('admin/order', [OrderBEController::class, 'index'])->name('be.order');

    //Route account
    Route::get('admin/account', [AccountBEController::class, 'index'])->name('be.account');
    Route::match(['get', 'post'], 'admin/account/add', [AccountBEController::class, 'add'])->name('be.accountadd');
    Route::match(['get', 'post'], 'admin/account/update/{id}', [AccountBEController::class, 'update'])->name('be.accountupdate');
    Route::get('admin/account/del/{id}', [AccountBEController::class, 'del'])->name('be.accountdel');
    
    //Route messcustomer
    Route::get('admin/messcustomer', [ContactBEController::class, 'index'])->name('be.messcustomer');
});
